...
let products = new Schema(
  {
    ...
    sku: { type: Schema.Types.String, required: false },
    category: { type: Schema.Types.ObjectId, required: true, ref: "category" },
    sellingPrice: { type: Schema.Types.Number, min: 0, required: true },
    purchasePrice: { type: Schema.Types.Number, min: 0, required: false },
    discountValue: { type: Schema.Types.Number, required: false, default: 0 },
    ...
    alertQuantity: { type: Schema.Types.Number, min: 0, required: false, default: 0 },
